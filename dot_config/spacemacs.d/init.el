...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(html
     ...
     treemacs
     helm
     (ruby :variables ruby-enable-enh-ruby-mode t ruby-backend 'robe ruby-test-runner 'rspec ruby-prettier-on-save t)
     ruby-on-rails)
